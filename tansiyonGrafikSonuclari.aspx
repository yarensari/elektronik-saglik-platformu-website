<%@ Page Title="" Language="C#" MasterPageFile="~/temel.Master" AutoEventWireup="true" CodeBehind="tansiyonGrafikSonuclari.aspx.cs" Inherits="elektronik_saglik_platformu_web_doktor.tansiyonGrafikSonuclari" %>
    ...
    <script>
        window.onload = function () {
            ...
            var myChart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: chartData.map(data => data.xEkseni), // X ekseni etiketleri (tarihler)
                    datasets: [{
                        label: 'SYS',
                        data: chartData.map(data => data.yEkseniSys), // SYS değerleri
                        backgroundColor: 'rgba(72, 203, 142, 0.2)',
                        borderColor: 'rgb(72, 203, 142)',
                        borderWidth: 1,
                        fill: false
                    }, {
                        label: 'DIA',
                        data: chartData.map(data => data.yEkseniDia), // DIA değerleri
