<%@ Page Title="" Language="C#" MasterPageFile="~/temel.Master" AutoEventWireup="true" CodeBehind="atesListeSonuclari.aspx.cs" Inherits="elektronik_saglik_platformu_web_doktor.atesListeSonuclariaspx" %>
    ...
    <div class="container">
        ...
        <div style="margin-top: 30px">
            <asp:GridView 
                ...
                >
                <Columns>
                    <asp:BoundField DataField="fever" HeaderText="VÜCUT ISISI" ItemStyle-Width="150" />
                    <asp:BoundField DataField="datetime_column" HeaderText="ÖLÇÜM TARİHİ" ItemStyle-Width="150" />
                </Columns>
            </asp:GridView>
        </div>       
    </div>
