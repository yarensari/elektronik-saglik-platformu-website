<%@ Page Title="" Language="C#" MasterPageFile="~/temel.Master" AutoEventWireup="true" CodeBehind="tansiyonListeSonuclari.aspx.cs" Inherits="elektronik_saglik_platformu_web_doktor.tansiyonListeSonuclari" %>
    ...
    <div class="container">
        ...
        <div style="margin-top: 30px">
            <asp:GridView 
                ...
                >
                <Columns>
                    <asp:BoundField DataField="sys" HeaderText="SYS" ItemStyle-Width="150" />
                    <asp:BoundField DataField="dia" HeaderText="DIA" ItemStyle-Width="150" />
