<%@ Page Title="" Language="C#" MasterPageFile="~/temel.Master" AutoEventWireup="true" CodeBehind="solunumListeSonuclari.aspx.cs" Inherits="elektronik_saglik_platformu_web_doktor.solunumListeSonuclari" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <Columns>
        <asp:TemplateField HeaderText="GRAFİK">
            <ItemTemplate>
                <asp:HyperLink 
                    ID="HyperLink1" 
                    runat="server" 
                    NavigateUrl='<%# Eval("id", "solunumDetay.aspx?id={0}") %>' 
        ...
        <asp:BoundField DataField="res_value" HeaderText="SOLUNUM" ItemStyle-Width="150" />
